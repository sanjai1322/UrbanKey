        ...
        for (const listing of allListings) {
            ...
            await prisma.property.create({
                data: {
                    ...
                    description: 'Experience luxury living in the heart of the city. This stunning property features modern finishes, open concept living areas, and breathtaking views.',
                }
            });
        }
